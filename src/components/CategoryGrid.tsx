    ...
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-5">
      {ALL_CATEGORIES.map((c) => (
        <Link
          ...
          className="group ios-tap relative block aspect-[4/3] overflow-hidden rounded-2xl border border-border bg-card shadow-soft transition-all duration-300 hover:-translate-y-0.5 hover:border-foreground/15 hover:shadow-soft-lg"
        >
          <img
