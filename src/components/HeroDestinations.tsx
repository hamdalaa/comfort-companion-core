          ...
          >
            ...
            <div className="relative aspect-[16/10] overflow-hidden bg-gradient-to-br from-muted/40 via-card to-background">
              ...
              <div className="absolute inset-0 z-0 flex items-center justify-center">
                <div
                  className={`relative flex h-20 w-20 items-center justify-center rounded-2xl ${a.iconBg} ring-1 ${a.ring} shadow-[0_10px_30px_-10px_hsl(var(--foreground)/0.15)] backdrop-blur-sm transition-transform duration-500 ease-ios [@media(hover:hover)]:group-hover:scale-110 [@media(hover:hover)]:group-hover:-rotate-3`}
                >
                  <Icon className={`h-10 w-10 ${a.iconText}`} strokeWidth={1.8} />
                  <span
                    aria-hidden
              ...
              <div className="absolute inset-x-0 bottom-0 z-10 p-4 sm:p-5">
                <h3 className="font-display truncate text-base font-semibold tracking-tight text-foreground sm:text-[17px]">
                  {d.title}
                </h3>
                <p className="mt-1 truncate text-[11.5px] text-muted-foreground sm:text-[12px]">
                  {d.meta}
                </p>
              </div>
            </div>
