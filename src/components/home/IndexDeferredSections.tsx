        ...
        <section className="container mt-10 sm:mt-20 md:mt-24">
          ...
          >
            ...
            <div className="grid gap-4 sm:gap-6 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
              <div>
                <h2 className="font-thmanyah-sans text-balance text-2xl font-bold leading-tight tracking-tight text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)] sm:text-4xl md:text-5xl">
              ...
              <div className="flex items-center gap-3 border-t border-white/20 pt-4 sm:gap-4 md:border-0 md:pt-0">
                <span className="font-thmanyah-sans text-base font-bold text-white sm:text-xl">
                  افتح الأطلس
                </span>
